...
Modified with Garry's Mod Integration by Wolvindra-Vinzuerio.
        ...
        */
        ...
        me.handleDeath = function() {
            function recordScore () {
				...
				if (highScore == undefined || highScore < 1 ) {
					console.log("RUNLUA:snake.post(0)");
				}else{
					console.log("RUNLUA:snake.post(" + me.snakeLength + "," + highScore + ")");
				}
                if (me.snakeLength > highScore) {
					//alert('Congratulations! You have beaten your previous high score, which was ' + highScore + '.');
					console.log("RUNLUA:snake.alert(" + highScore + "," + me.snakeLength + ")");
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "HINT: Setiap Score kelipatan 10 = 1+ Pointshop Points Bonus!";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "AWSnake<p></p>Use the <strong>arrow keys (&lt; &gt; ^ v) </strong> on your keyboard to play the game." + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Start Game"));
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "AWSnake<p></p>You died :(.<p></p>";
